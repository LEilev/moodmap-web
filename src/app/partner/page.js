// File: src/app/partner/page.js

import { Shield, RefreshCcw, Smartphone } from "lucide-react";  // (If any icons were needed; none used in current content)
      ...
      <div className="max-w-3xl mx-auto p-6">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 text-lg list-disc list-inside text-blue-100">
            <li>
              <strong className="text-white">Make a difference:</strong> Help promote awareness between partners. By sharing MoodMap, you foster understanding and emotional intelligence in relationships.
            </li>
            <li>
              <strong className="text-white">Earn by spreading empathy:</strong> Get 50% of every MoodMap subscription from the users you bring in – and keep earning as long as they stay subscribed.
            </li>
            <li>
              <strong className="text-white">Simple &amp; transparent:</strong> It’s free to join and easy to start. Our partner portal (powered by PromoteKit) provides your unique link and real-time tracking of clicks, sign-ups, and earnings.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ol className="space-y-4 text-lg list-decimal list-inside text-blue-100">
            <li>
              <strong className="text-white">Sign Up</strong> – Join the partner program through our <em>MoodMap Partner Portal</em> (via PromoteKit). It takes just a minute to sign up, and you’ll be all set with your dashboard.
            </li>
            <li>
              <strong className="text-white">Share Your Link</strong> – Spread the word about MoodMap using your unique referral link. Show your audience how this app helps men and partners understand each other better, leading to stronger relationships.
            </li>
            <li>
              <strong className="text-white">Earn 50%</strong> – For every person who subscribes via your link, you earn 50% of their subscription. MoodMap subscriptions cost <strong>$3.99/month</strong> (or <strong>$29.99/year</strong>), and you get half of that for each subscriber you bring in. You’ll continue to earn every month for as long as they remain subscribed. We handle tracking and payouts automatically, so you can focus on sharing and earning.
            </li>
          </ol>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-blue-100 text-base sm:text-lg mb-4">
            MoodMap’s mission is to <strong className="text-white">help promote awareness and emotional intelligence in relationships.</strong> By partnering with us, you’re not just earning — you’re helping couples connect on a deeper level. In other words, you’re joining the movement that turns emotional insight into connection.
          </p>
          <p className="text-blue-100 text-base sm:text-lg">
