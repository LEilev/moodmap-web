    ...
    <main className="min-h-[70vh] bg-primary-blue text-white">
      <section className="max-w-3xl mx-auto px-6 py-16 text-center">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <a
            href={LINKS.monthly}
            className="inline-flex flex-col items-center justify-center rounded-xl bg-white/95 text-primary-blue font-semibold py-4 px-6 shadow-sm ring-1 ring-white/30 hover:shadow-lg hover:scale-[1.02] transition focus:outline-none focus:ring-2 focus:ring-white"
          >
            <span className="text-base">Get Pro – Monthly</span>
            <span className="text-sm opacity-90">$3.99 / month</span>
          </a>

          {/* Yearly (highlight) */}
          <a
            href={LINKS.yearly}
            className="relative inline-flex flex-col items-center justify-center rounded-xl bg-gradient-to-r from-emerald-400 to-emerald-500 text-primary-blue font-semibold py-5 px-6 shadow-md hover:shadow-lg hover:scale-[1.03] transition focus:outline-none focus:ring-2 focus:ring-emerald-300"
          >
            ...
            <span className="text-sm opacity-95">$39.99 / year · Save 37%</span>
          </a>
        </div>
