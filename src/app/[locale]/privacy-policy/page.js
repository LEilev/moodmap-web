...
export async function generateMetadata({ params }) {
  const { locale } = params;
  const privacyMessages = (await import(`../../../../locales/${locale}/privacy.json`)).default;
  return {
    title: privacyMessages.metaTitle,
    description: privacyMessages.metaDescription
  };
}
...
function GlassCard({ id, children }) {
  return (
    <article id={id} className="scroll-mt-24 rounded-2xl bg-white/12 ring-1 ring-white/10 
  ...
  return (
    <main className="relative isolate min-h-screen bg-primary-blue text-white">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute -left-40 -top-24 
        h-[34rem] w-[34rem] rounded-full bg-gradient-to-br from-emerald-400/25 to-blue-500/25 
        blur-[140px] sm:blur-[180px] md:opacity-30 -z-10" />
      <div aria-hidden="true" className="pointer-events-none absolute -right-40 top-32 
        h-[36rem] w-[36rem] rounded-full bg-gradient-to-tr from-blue-500/25 to-emerald-400/25 
        blur-[160px] sm:blur-[200px] md:opacity-30 -z-10" />

      {/* Hero */}
      <section className="px-6 pt-16 pb-8 sm:pt-20 sm:pb-10 text-center">
        <div className="mx-auto max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/12 ring-1 
            ring-white/20 px-3 py-1 text-xs font-semibold text-blue-100"
          >
      ...
      <section className="px-6 pb-8">
        <div className="mx-auto max-w-4xl">
          ...
          <details className="sm:hidden rounded-2xl bg-white/12 ring-1 ring-white/10 backdrop-blur-xl">
            <summary className="list-none cursor-pointer select-none px-4 py-3 font-semibold">
              <span className="inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm text-white 
                bg-gradient-to-r from-emerald-400 to-blue-600 ring-1 ring-white/10 
          ...
          {/* Desktop TOC */}
          <nav className="hidden sm:block rounded-2xl bg-white/12 ring-1 ring-white/10 backdrop-blur-xl p-5" 
            role="navigation" aria-label={t('toc.title')} data-pp-toc
          >
      ...
      <section className="px-6 pb-16">
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          <GlassCard id="section1">
            <IconRing><Database className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section2">
            <IconRing><BarChart3 className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section3">
            <IconRing><Share2 className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section4">
            <IconRing><Shield className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section5">
            <IconRing><Trash2 className="h-6 w-6 text-white drop-shadow" /></IconRing>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              ...
              <a href="mailto:support@moodmap-app.com" className="underline decoration-white/40 hover:decoration-white/70">
          ...
          <GlassCard id="section6">
            <IconRing><HeartOff className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section7">
            <IconRing><Bell className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section8">
            <IconRing><CheckCircle2 className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section9">
            <IconRing><RefreshCcw className="h-6 w-6 text-white drop-shadow" /></IconRing>
          ...
          <GlassCard id="section10">
            <IconRing><Mail className="h-6 w-6 text-white drop-shadow" /></IconRing>
