    ...
    <div className="relative isolate bg-primary-blue text-white">
      ...
      <section className="px-6 pt-16 pb-12 sm:pt-20 sm:pb-16 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-5 text-pretty text-base sm:text-lg text-blue-100">{t('hero.subtitle')}</p>

          {/* CTA-knapper – beholder kjøpsflyten (locale={false}) */}
          <div className="mt-8 flex flex-col sm:flex-row items-stretch justify-center gap-3 sm:gap-4">
            <Link
              ...
              className="group relative inline-flex items-center justify-center rounded-xl px-7 py-4 text-base font-semibold text-white bg-gradient-to-r from-emerald-400 to-emerald-500 shadow-[0_10px_30px_rgba(16,185,129,0.35)] ring-1 ring-emerald-300/40 transition hover:-translate-y-0.5 hover:shadow-[0_14px_40px_rgba(16,185,129,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-300/80"
            >
              ...
              <span aria-hidden="true" className="pointer-events-none absolute inset-0 rounded-xl opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'linear-gradient(180deg, rgba(255,255,255,0.18), rgba(255,255,255,0.00))'}} />
            </Link>
            ...
            <Link
              ...
              className="group relative inline-flex items-center justify-center rounded-xl px-7 py-4 text-base font-semibold text-white bg-gradient-to-r from-blue-500 to-blue-600 shadow-[0_10px_30px_rgba(59,130,246,0.35)] ring-1 ring-blue-300/45 transition hover:-translate-y-0.5 hover:shadow-[0_14px_40px_rgba(59,130,246,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300/80"
            >
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 sm:gap-7 md:grid-cols-2 lg:grid-cols-4">
          {features.map(({icon: Icon, title, desc}) => (
            ...
            >
              ...
              <div aria-hidden="true" className="pointer-events-none absolute -right-10 -top-10 h-32 w-32 rounded-full bg-gradient-to-br from-white/10 to-transparent blur-2xl transition-opacity duration-300 group-hover:opacity-80" />
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl rounded-2xl border border-white/12 bg-white/10 p-6 sm:p-8">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-stretch justify-center gap-3 sm:gap-4">
            <Link
              ...
              prefetch={false}
              aria-label={t('cta.yearly.aria')}
              className="group relative inline-flex items-center justify-center rounded-xl px-6 py-3 text-base font-semibold text-white bg-gradient-to-r from-emerald-400 to-emerald-500 ring-1 ring-emerald-300/45 shadow-[0_8px_24px_rgba(16,185,129,0.35)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_32px_rgba(16,185,129,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-300/80"
            >
            ...
            <Link
              ...
              prefetch={false}
              aria-label={t('cta.monthly.aria')}
              className="group relative inline-flex items-center justify-center rounded-xl px-6 py-3 text-base font-semibold text-white bg-gradient-to-r from-blue-500 to-blue-600 ring-1 ring-blue-300/45 shadow-[0_8px_24px_rgba(59,130,246,0.35)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_32px_rgba(59,130,246,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300/80"
            >
