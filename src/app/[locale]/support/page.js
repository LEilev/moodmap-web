...
export default function SupportPage() {
  ...
  return (
    <main className="relative isolate min-h-screen flex flex-col items-center bg-primary-blue text-white px-6 py-16">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute -right-44 top-48 h-[36rem] w-[36rem] rounded-full bg-gradient-to-tr from-blue-500/25 to-emerald-400/25 blur-[160px] sm:blur-[200px] md:opacity-30 -z-10" />
      ...
      <div className="max-w-xl w-full space-y-10">
        ...
        <section className="grid gap-6">
          ...
          <article className="group relative overflow-hidden rounded-2xl bg-white/12 p-5 sm:p-6 ring-1 ring-white/10 backdrop-blur-xl">
            ...
            <div aria-hidden className="pointer-events-none absolute -right-10 -top-10 h-32 w-32 rounded-full bg-gradient-to-br from-white/10 to-transparent blur-2xl" />
          </article>
